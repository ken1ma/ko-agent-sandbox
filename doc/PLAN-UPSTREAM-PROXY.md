...
failure makes `podman start` fail and the launcher removes the run's containers and networks. Each
HTTPS connection verifies endpoint identity before sending authentication.
